...
/**
 * This object is only required if the charge request is using an google pay instrument.
 */
@ApiModel(description = "This object is only required if the charge request is using an google pay instrument.")

public class ChargePaymentAgreementRequestTransactionTypeGooglePay implements Serializable {
  ...
  public ChargePaymentAgreementRequestTransactionTypeGooglePay creditCard(CreditCardEnum creditCard) {
   ...
   * @return creditCard
  **/
  @ApiModelProperty(required = true, value = "The container transaction type to use for google pay credit card instruments.")
  ...
  public ChargePaymentAgreementRequestTransactionTypeGooglePay debitCard(DebitCardEnum debitCard) {
   ...
   * @return debitCard
  **/
  @ApiModelProperty(required = true, value = "The container transaction type to use for google pay debit card instruments. Only PURCHASE is currently supported for google pay debit card instruments.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ChargePaymentAgreementRequestTransactionTypeGooglePay chargePaymentAgreementRequestTransactionTypeGooglePay = (ChargePaymentAgreementRequestTransactionTypeGooglePay) o;
    return Objects.equals(this.creditCard, chargePaymentAgreementRequestTransactionTypeGooglePay.creditCard) &&
        Objects.equals(this.debitCard, chargePaymentAgreementRequestTransactionTypeGooglePay.debitCard);
  }
  ...
  public String toString() {
    ...
    sb.append("class ChargePaymentAgreementRequestTransactionTypeGooglePay {\n");
