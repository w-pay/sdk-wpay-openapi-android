...
public class MerchantTransactionDetail implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionId, type, executionTime, status, statusDetail, refundReason, paymentRequestId, merchantReferenceId, grossAmount, walletId, basket, posPayload, merchantPayload);
  }
