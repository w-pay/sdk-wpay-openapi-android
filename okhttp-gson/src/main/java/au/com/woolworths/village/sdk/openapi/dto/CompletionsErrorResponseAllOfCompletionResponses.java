...
/**
 * CompletionsErrorResponseAllOfCompletionResponses
 */

public class CompletionsErrorResponseAllOfCompletionResponses implements Serializable {
  ...
  public CompletionsErrorResponseAllOfCompletionResponses paymentTransactionRef(String paymentTransactionRef) {
  ...
  **/
  ...
  public CompletionsErrorResponseAllOfCompletionResponses errorCode(String errorCode) {
  ...
  **/
  ...
  public CompletionsErrorResponseAllOfCompletionResponses errorMessage(String errorMessage) {
  ...
  **/
  ...
  public CompletionsErrorResponseAllOfCompletionResponses errorDetail(String errorDetail) {
  ...
  **/
  ...
  public CompletionsErrorResponseAllOfCompletionResponses externalServiceCode(String externalServiceCode) {
  ...
  **/
  @ApiModelProperty(example = "05", required = true, value = "The external service code (from eg. Webpay). This property is only included in the response if it is enabled in the consumers API configuration.")
  ...
  public CompletionsErrorResponseAllOfCompletionResponses externalServiceMessage(String externalServiceMessage) {
  ...
  **/
  @ApiModelProperty(example = "DO NOT HONOUR", required = true, value = "The external service message (from eg. Webpay). This property is only included in the response if it is enabled in the consumers API configuration.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CompletionsErrorResponseAllOfCompletionResponses completionsErrorResponseAllOfCompletionResponses = (CompletionsErrorResponseAllOfCompletionResponses) o;
    return Objects.equals(this.paymentTransactionRef, completionsErrorResponseAllOfCompletionResponses.paymentTransactionRef) &&
        Objects.equals(this.errorCode, completionsErrorResponseAllOfCompletionResponses.errorCode) &&
        Objects.equals(this.errorMessage, completionsErrorResponseAllOfCompletionResponses.errorMessage) &&
        Objects.equals(this.errorDetail, completionsErrorResponseAllOfCompletionResponses.errorDetail) &&
        Objects.equals(this.externalServiceCode, completionsErrorResponseAllOfCompletionResponses.externalServiceCode) &&
        Objects.equals(this.externalServiceMessage, completionsErrorResponseAllOfCompletionResponses.externalServiceMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompletionsErrorResponseAllOfCompletionResponses {\n");
