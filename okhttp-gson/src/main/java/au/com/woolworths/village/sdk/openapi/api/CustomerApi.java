...
public class CustomerApi {
    ...
    /**
     * Build call for updateCustomerPaymentSession
     * @param xWalletID  (required)
     * @param paymentSessionId The ID of the specific payment session to retrieve (required)
     ...
     */
    public okhttp3.Call updateCustomerPaymentSessionCall(String xWalletID, String paymentSessionId, UpdatePaymentSessionRequest updatePaymentSessionRequest, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updateCustomerPaymentSessionValidateBeforeCall(String xWalletID, String paymentSessionId, UpdatePaymentSessionRequest updatePaymentSessionRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'xWalletID' is set
        if (xWalletID == null) {
            throw new ApiException("Missing the required parameter 'xWalletID' when calling updateCustomerPaymentSession(Async)");
        }
        
        // verify the required parameter 'paymentSessionId' is set
        if (paymentSessionId == null) {
            throw new ApiException("Missing the required parameter 'paymentSessionId' when calling updateCustomerPaymentSession(Async)");
        }
        
        // verify the required parameter 'updatePaymentSessionRequest' is set
        if (updatePaymentSessionRequest == null) {
            throw new ApiException("Missing the required parameter 'updatePaymentSessionRequest' when calling updateCustomerPaymentSession(Async)");
        }
        

        okhttp3.Call localVarCall = updateCustomerPaymentSessionCall(xWalletID, paymentSessionId, updatePaymentSessionRequest, _callback);
        return localVarCall;
     ...
     */
    public void updateCustomerPaymentSession(String xWalletID, String paymentSessionId, UpdatePaymentSessionRequest updatePaymentSessionRequest) throws ApiException {
        updateCustomerPaymentSessionWithHttpInfo(xWalletID, paymentSessionId, updatePaymentSessionRequest);
    }
     ...
     */
    public ApiResponse<Void> updateCustomerPaymentSessionWithHttpInfo(String xWalletID, String paymentSessionId, UpdatePaymentSessionRequest updatePaymentSessionRequest) throws ApiException {
        okhttp3.Call localVarCall = updateCustomerPaymentSessionValidateBeforeCall(xWalletID, paymentSessionId, updatePaymentSessionRequest, null);
        return localVarApiClient.execute(localVarCall);
    }
     ...
     */
    public okhttp3.Call updateCustomerPaymentSessionAsync(String xWalletID, String paymentSessionId, UpdatePaymentSessionRequest updatePaymentSessionRequest, final ApiCallback<Void> _callback) throws ApiException {

        okhttp3.Call localVarCall = updateCustomerPaymentSessionValidateBeforeCall(xWalletID, paymentSessionId, updatePaymentSessionRequest, _callback);
        localVarApiClient.executeAsync(localVarCall, _callback);
        return localVarCall;
    }
}
