...
import au.com.woolworths.village.sdk.openapi.dto.ImmediatePaymentRequest;
...
public class CustomerApi {
    ...
    /**
     * Build call for makeImmediateCustomerPayments
     * @param xApiKey The API key for the request. The API keys (non-prod/prod) will be supplied by the Digital Pay team. (required)
     * @param authorization The Bearer token for the request. The Bearer token authentication approach can be used by API consumers that implement a client-to-server architecture (mobile app, browser site/page) or server-to-server architecture (BFF, microservice, web server, etc.) for calling Digital Pay APIs. However the Bearer token for a shopper/customer must be obtained from the IDM Server Token API which can only be accessed from a server-to-server architecture (BFF, microservice, web server, etc.). The Authorization header is only required if the X-JWS-Signature header is not present. (required)
     * @param xJWSSignature The JWS signature used to sign the request. The JWS signature authentication approach can only be used by API consumers that implement a server-to-server architecture (BFF, microservice, web server, etc.) for calling the Digital Pay APIs. The RSA private key, required to generate the signiture, has to be stored securely and should not be publicly accessible. The X-JWS-Signature header is only required if the Authorization header is not present. (required)
     * @param immediatePaymentRequest Request payload containing instruments to use for the payment (required)
     * @param xAuthKey (Deprecated) You are required to use this header to provide the base64 encoded API key. Requires the X-Auth-Digest header to be present. (optional)
     * @param xAuthDigest (Deprecated) You are required to use this header to provide the encrypted API key. The value is the API key encrypted with the client secret key. Requires the X-Auth-Key header to be present. (optional)
     * @param xMessageId This id is used to keep track of the request and its response in the Digital Pay platform. If no value is provided for the request header, Apigee will auto generate an id to use for the request. This header will also be returned in the response and will have the value passed in (or auto generated) from the request. (optional)
     * @param xEverydayPayWallet The makes instruments available in the everyday pay wallet available for payments (optional, default to false)
     ...
     */
    public okhttp3.Call makeImmediateCustomerPaymentsCall(String xApiKey, String authorization, String xJWSSignature, ImmediatePaymentRequest immediatePaymentRequest, String xAuthKey, String xAuthDigest, String xMessageId, Boolean xEverydayPayWallet, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = immediatePaymentRequest;

        // create path and map variables
        String localVarPath = "/instore/customer/payments";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call makeImmediateCustomerPaymentsValidateBeforeCall(String xApiKey, String authorization, String xJWSSignature, ImmediatePaymentRequest immediatePaymentRequest, String xAuthKey, String xAuthDigest, String xMessageId, Boolean xEverydayPayWallet, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'xApiKey' is set
        if (xApiKey == null) {
            throw new ApiException("Missing the required parameter 'xApiKey' when calling makeImmediateCustomerPayments(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling makeImmediateCustomerPayments(Async)");
        }
        
        // verify the required parameter 'xJWSSignature' is set
        if (xJWSSignature == null) {
            throw new ApiException("Missing the required parameter 'xJWSSignature' when calling makeImmediateCustomerPayments(Async)");
        }
        
        // verify the required parameter 'immediatePaymentRequest' is set
        if (immediatePaymentRequest == null) {
            throw new ApiException("Missing the required parameter 'immediatePaymentRequest' when calling makeImmediateCustomerPayments(Async)");
        }
        

        okhttp3.Call localVarCall = makeImmediateCustomerPaymentsCall(xApiKey, authorization, xJWSSignature, immediatePaymentRequest, xAuthKey, xAuthDigest, xMessageId, xEverydayPayWallet, _callback);
        return localVarCall;
     ...
     */
    public MakeCustomerPaymentResults makeImmediateCustomerPayments(String xApiKey, String authorization, String xJWSSignature, ImmediatePaymentRequest immediatePaymentRequest, String xAuthKey, String xAuthDigest, String xMessageId, Boolean xEverydayPayWallet) throws ApiException {
        ApiResponse<MakeCustomerPaymentResults> localVarResp = makeImmediateCustomerPaymentsWithHttpInfo(xApiKey, authorization, xJWSSignature, immediatePaymentRequest, xAuthKey, xAuthDigest, xMessageId, xEverydayPayWallet);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MakeCustomerPaymentResults> makeImmediateCustomerPaymentsWithHttpInfo(String xApiKey, String authorization, String xJWSSignature, ImmediatePaymentRequest immediatePaymentRequest, String xAuthKey, String xAuthDigest, String xMessageId, Boolean xEverydayPayWallet) throws ApiException {
        okhttp3.Call localVarCall = makeImmediateCustomerPaymentsValidateBeforeCall(xApiKey, authorization, xJWSSignature, immediatePaymentRequest, xAuthKey, xAuthDigest, xMessageId, xEverydayPayWallet, null);
        Type localVarReturnType = new TypeToken<MakeCustomerPaymentResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Immediate Customer Payments (asynchronously)
     * Make payments to a merchant using payment intruments. This endpoint establishes a payment request and then makes a payment against it.
     * @param xApiKey The API key for the request. The API keys (non-prod/prod) will be supplied by the Digital Pay team. (required)
     * @param authorization The Bearer token for the request. The Bearer token authentication approach can be used by API consumers that implement a client-to-server architecture (mobile app, browser site/page) or server-to-server architecture (BFF, microservice, web server, etc.) for calling Digital Pay APIs. However the Bearer token for a shopper/customer must be obtained from the IDM Server Token API which can only be accessed from a server-to-server architecture (BFF, microservice, web server, etc.). The Authorization header is only required if the X-JWS-Signature header is not present. (required)
     * @param xJWSSignature The JWS signature used to sign the request. The JWS signature authentication approach can only be used by API consumers that implement a server-to-server architecture (BFF, microservice, web server, etc.) for calling the Digital Pay APIs. The RSA private key, required to generate the signiture, has to be stored securely and should not be publicly accessible. The X-JWS-Signature header is only required if the Authorization header is not present. (required)
     ...
     */
    public okhttp3.Call makeImmediateCustomerPaymentsAsync(String xApiKey, String authorization, String xJWSSignature, ImmediatePaymentRequest immediatePaymentRequest, String xAuthKey, String xAuthDigest, String xMessageId, Boolean xEverydayPayWallet, final ApiCallback<MakeCustomerPaymentResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = makeImmediateCustomerPaymentsValidateBeforeCall(xApiKey, authorization, xJWSSignature, immediatePaymentRequest, xAuthKey, xAuthDigest, xMessageId, xEverydayPayWallet, _callback);
        Type localVarReturnType = new TypeToken<MakeCustomerPaymentResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
