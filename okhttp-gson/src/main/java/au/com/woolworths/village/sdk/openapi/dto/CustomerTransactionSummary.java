...
public class CustomerTransactionSummary implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(transactionId, type, executionTime, status, statusDetail, refundReason, paymentRequestId, merchantReferenceId, grossAmount, merchantId, instruments);
  }
