...
/**
 * RefundsErrorResponseRefundResponses
 */

public class RefundsErrorResponseRefundResponses implements Serializable {
  ...
  public RefundsErrorResponseRefundResponses paymentTransactionRef(String paymentTransactionRef) {
  ...
  **/
  ...
  public RefundsErrorResponseRefundResponses errorCode(String errorCode) {
  ...
  **/
  ...
  public RefundsErrorResponseRefundResponses errorMessage(String errorMessage) {
  ...
  **/
  ...
  public RefundsErrorResponseRefundResponses errorDetail(String errorDetail) {
  ...
  **/
  ...
  public RefundsErrorResponseRefundResponses externalServiceCode(String externalServiceCode) {
  ...
  **/
  ...
  public RefundsErrorResponseRefundResponses externalServiceMessage(String externalServiceMessage) {
  ...
  **/
  @ApiModelProperty(example = "INVALID REFUND AUTH NOT FOUND", required = true, value = "The external service message (from eg. Webpay). This property is only included in the response if it is enabled in the consumers API configuration.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RefundsErrorResponseRefundResponses refundsErrorResponseRefundResponses = (RefundsErrorResponseRefundResponses) o;
    return Objects.equals(this.paymentTransactionRef, refundsErrorResponseRefundResponses.paymentTransactionRef) &&
        Objects.equals(this.errorCode, refundsErrorResponseRefundResponses.errorCode) &&
        Objects.equals(this.errorMessage, refundsErrorResponseRefundResponses.errorMessage) &&
        Objects.equals(this.errorDetail, refundsErrorResponseRefundResponses.errorDetail) &&
        Objects.equals(this.externalServiceCode, refundsErrorResponseRefundResponses.externalServiceCode) &&
        Objects.equals(this.externalServiceMessage, refundsErrorResponseRefundResponses.externalServiceMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class RefundsErrorResponseRefundResponses {\n");
