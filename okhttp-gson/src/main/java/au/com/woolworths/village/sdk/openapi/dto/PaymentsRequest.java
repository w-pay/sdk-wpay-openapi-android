...
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestBasketData;
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestExtendedMerchantData;
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestFraudPayload;
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestPayments;
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestShippingAddress;
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestStoreData;
import au.com.woolworths.village.sdk.openapi.dto.PaymentsRequestTransactionType;
...
public class PaymentsRequest implements Serializable {
  ...
  private List<PaymentsRequestBasketData> basketData = null;
  ...
  **/
  ...
  public PaymentsRequest addExtendedMerchantDataItem(PaymentsRequestExtendedMerchantData extendedMerchantDataItem) {
   ...
   /**
   * This array is only required if the payments request contains paypal instruments.
   * @return extendedMerchantData
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This array is only required if the payments request contains paypal instruments.")
  ...
  **/
  ...
  public PaymentsRequest basketData(List<PaymentsRequestBasketData> basketData) {
    
    this.basketData = basketData;
    return this;
  }

  public PaymentsRequest addBasketDataItem(PaymentsRequestBasketData basketDataItem) {
    if (this.basketData == null) {
      this.basketData = new ArrayList<PaymentsRequestBasketData>();
    }
   ...
   /**
   * This array is only required if an implicit restricted product validation (RPVS) is required during the execution of the payment for the relevant merchant. A merchant can be opted-out of this restricted product validation via configuration.
   * @return basketData
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "This array is only required if an implicit restricted product validation (RPVS) is required during the execution of the payment for the relevant merchant. A merchant can be opted-out of this restricted product validation via configuration.")

  public List<PaymentsRequestBasketData> getBasketData() {
    return basketData;
  }


  public void setBasketData(List<PaymentsRequestBasketData> basketData) {
    this.basketData = basketData;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.transactionType, paymentsRequest.transactionType) &&
        ...
        Objects.equals(this.basketData, paymentsRequest.basketData) &&
        Objects.equals(this.fraudPayload, paymentsRequest.fraudPayload);
  }

  @Override
  public int hashCode() {
    return Objects.hash(transactionType, clientReference, orderNumber, shippingAddress, payments, extendedMerchantData, storeData, basketData, fraudPayload);
  }
