...
/**
 * MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard
 */

public class MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard implements Serializable {
  ...
  public MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard allowedNetworks(List<String> allowedNetworks) {
    
    this.allowedNetworks = allowedNetworks;
    return this;
  }

  public MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard addAllowedNetworksItem(String allowedNetworksItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The allowed networks (schemes) for debit card transactions.")
  ...
  public MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard allowedTransactionTypes(List<AllowedTransactionTypesEnum> allowedTransactionTypes) {
    
    this.allowedTransactionTypes = allowedTransactionTypes;
    return this;
  }

  public MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard addAllowedTransactionTypesItem(AllowedTransactionTypesEnum allowedTransactionTypesItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The allowed transaction types for debit card transactions.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard merchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard = (MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard) o;
    return Objects.equals(this.allowedNetworks, merchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard.allowedNetworks) &&
        Objects.equals(this.allowedTransactionTypes, merchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard.allowedTransactionTypes);
  }
  ...
  public String toString() {
    ...
    sb.append("class MerchantProfileResponseAllowedPaymentMethodsGooglePayDebitCard {\n");
