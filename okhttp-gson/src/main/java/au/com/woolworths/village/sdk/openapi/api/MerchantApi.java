...
import au.com.woolworths.village.sdk.openapi.dto.MerchantTransactionResults;
...
public class MerchantApi {
    ...
    /**
     * Build call for instoreMerchantTransactionsTransactionIdCompletionPost
     * @param xApiKey The API key for the request. The API keys (non-prod/prod) will be supplied by the Digital Pay team. (required)
     * @param authorization The Bearer token for the request. The Bearer token authentication approach can be used by API consumers that implement a client-to-server architecture (mobile app, browser site/page) or server-to-server architecture (BFF, microservice, web server, etc.) for calling Digital Pay APIs. However the Bearer token for a shopper/customer must be obtained from the IDM Server Token API which can only be accessed from a server-to-server architecture (BFF, microservice, web server, etc.). The Authorization header is only required if the X-JWS-Signature header is not present. (required)
     * @param xJWSSignature The JWS signature used to sign the request. The JWS signature authentication approach can only be used by API consumers that implement a server-to-server architecture (BFF, microservice, web server, etc.) for calling the Digital Pay APIs. The RSA private key, required to generate the signiture, has to be stored securely and should not be publicly accessible. The X-JWS-Signature header is only required if the Authorization header is not present. (required)
     * @param transactionId The ID of the transaction to operate on (required)
     * @param xAuthKey (Deprecated) You are required to use this header to provide the base64 encoded API key. Requires the X-Auth-Digest header to be present. (optional)
     * @param xAuthDigest (Deprecated) You are required to use this header to provide the encrypted API key. The value is the API key encrypted with the client secret key. Requires the X-Auth-Key header to be present. (optional)
     * @param xMessageId This id is used to keep track of the request and its response in the Digital Pay platform. If no value is provided for the request header, Apigee will auto generate an id to use for the request. This header will also be returned in the response and will have the value passed in (or auto generated) from the request. (optional)
     ...
     */
    public okhttp3.Call instoreMerchantTransactionsTransactionIdCompletionPostCall(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject inlineObject, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = inlineObject;

        // create path and map variables
        String localVarPath = "/instore/merchant/transactions/{transactionId}/completion"
            .replaceAll("\\{" + "transactionId" + "\\}", localVarApiClient.escapeString(transactionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call instoreMerchantTransactionsTransactionIdCompletionPostValidateBeforeCall(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject inlineObject, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'xApiKey' is set
        if (xApiKey == null) {
            throw new ApiException("Missing the required parameter 'xApiKey' when calling instoreMerchantTransactionsTransactionIdCompletionPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling instoreMerchantTransactionsTransactionIdCompletionPost(Async)");
        }
        
        // verify the required parameter 'xJWSSignature' is set
        if (xJWSSignature == null) {
            throw new ApiException("Missing the required parameter 'xJWSSignature' when calling instoreMerchantTransactionsTransactionIdCompletionPost(Async)");
        }
        
        // verify the required parameter 'transactionId' is set
        if (transactionId == null) {
            throw new ApiException("Missing the required parameter 'transactionId' when calling instoreMerchantTransactionsTransactionIdCompletionPost(Async)");
        }
        

        okhttp3.Call localVarCall = instoreMerchantTransactionsTransactionIdCompletionPostCall(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject, _callback);
        return localVarCall;
     ...
     * @param xMessageId This id is used to keep track of the request and its response in the Digital Pay platform. If no value is provided for the request header, Apigee will auto generate an id to use for the request. This header will also be returned in the response and will have the value passed in (or auto generated) from the request. (optional)
     * @param inlineObject  (optional)
     * @return MerchantTransactionResults
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public MerchantTransactionResults instoreMerchantTransactionsTransactionIdCompletionPost(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject inlineObject) throws ApiException {
        ApiResponse<MerchantTransactionResults> localVarResp = instoreMerchantTransactionsTransactionIdCompletionPostWithHttpInfo(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject);
        return localVarResp.getData();
    }
     ...
     * @param xMessageId This id is used to keep track of the request and its response in the Digital Pay platform. If no value is provided for the request header, Apigee will auto generate an id to use for the request. This header will also be returned in the response and will have the value passed in (or auto generated) from the request. (optional)
     * @param inlineObject  (optional)
     * @return ApiResponse&lt;MerchantTransactionResults&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<MerchantTransactionResults> instoreMerchantTransactionsTransactionIdCompletionPostWithHttpInfo(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject inlineObject) throws ApiException {
        okhttp3.Call localVarCall = instoreMerchantTransactionsTransactionIdCompletionPostValidateBeforeCall(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject, null);
        Type localVarReturnType = new TypeToken<MerchantTransactionResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call instoreMerchantTransactionsTransactionIdCompletionPostAsync(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject inlineObject, final ApiCallback<MerchantTransactionResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = instoreMerchantTransactionsTransactionIdCompletionPostValidateBeforeCall(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject, _callback);
        Type localVarReturnType = new TypeToken<MerchantTransactionResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for instoreMerchantTransactionsTransactionIdVoidPost
     * @param xApiKey The API key for the request. The API keys (non-prod/prod) will be supplied by the Digital Pay team. (required)
     * @param authorization The Bearer token for the request. The Bearer token authentication approach can be used by API consumers that implement a client-to-server architecture (mobile app, browser site/page) or server-to-server architecture (BFF, microservice, web server, etc.) for calling Digital Pay APIs. However the Bearer token for a shopper/customer must be obtained from the IDM Server Token API which can only be accessed from a server-to-server architecture (BFF, microservice, web server, etc.). The Authorization header is only required if the X-JWS-Signature header is not present. (required)
     * @param xJWSSignature The JWS signature used to sign the request. The JWS signature authentication approach can only be used by API consumers that implement a server-to-server architecture (BFF, microservice, web server, etc.) for calling the Digital Pay APIs. The RSA private key, required to generate the signiture, has to be stored securely and should not be publicly accessible. The X-JWS-Signature header is only required if the Authorization header is not present. (required)
     * @param transactionId The ID of the transaction to operate on (required)
     ...
     */
    public okhttp3.Call instoreMerchantTransactionsTransactionIdVoidPostCall(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject1 inlineObject1, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = inlineObject1;

        // create path and map variables
        String localVarPath = "/instore/merchant/transactions/{transactionId}/void"
            .replaceAll("\\{" + "transactionId" + "\\}", localVarApiClient.escapeString(transactionId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call instoreMerchantTransactionsTransactionIdVoidPostValidateBeforeCall(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject1 inlineObject1, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'xApiKey' is set
        if (xApiKey == null) {
            throw new ApiException("Missing the required parameter 'xApiKey' when calling instoreMerchantTransactionsTransactionIdVoidPost(Async)");
        }
        
        // verify the required parameter 'authorization' is set
        if (authorization == null) {
            throw new ApiException("Missing the required parameter 'authorization' when calling instoreMerchantTransactionsTransactionIdVoidPost(Async)");
        }
        
        // verify the required parameter 'xJWSSignature' is set
        if (xJWSSignature == null) {
            throw new ApiException("Missing the required parameter 'xJWSSignature' when calling instoreMerchantTransactionsTransactionIdVoidPost(Async)");
        }
        
        // verify the required parameter 'transactionId' is set
        if (transactionId == null) {
            throw new ApiException("Missing the required parameter 'transactionId' when calling instoreMerchantTransactionsTransactionIdVoidPost(Async)");
        }
        

        okhttp3.Call localVarCall = instoreMerchantTransactionsTransactionIdVoidPostCall(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject1, _callback);
        return localVarCall;
     ...
     */
    public MerchantTransactionResults instoreMerchantTransactionsTransactionIdVoidPost(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject1 inlineObject1) throws ApiException {
        ApiResponse<MerchantTransactionResults> localVarResp = instoreMerchantTransactionsTransactionIdVoidPostWithHttpInfo(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject1);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MerchantTransactionResults> instoreMerchantTransactionsTransactionIdVoidPostWithHttpInfo(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject1 inlineObject1) throws ApiException {
        okhttp3.Call localVarCall = instoreMerchantTransactionsTransactionIdVoidPostValidateBeforeCall(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject1, null);
        Type localVarReturnType = new TypeToken<MerchantTransactionResults>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call instoreMerchantTransactionsTransactionIdVoidPostAsync(String xApiKey, String authorization, String xJWSSignature, String transactionId, String xAuthKey, String xAuthDigest, String xMessageId, InlineObject1 inlineObject1, final ApiCallback<MerchantTransactionResults> _callback) throws ApiException {

        okhttp3.Call localVarCall = instoreMerchantTransactionsTransactionIdVoidPostValidateBeforeCall(xApiKey, authorization, xJWSSignature, transactionId, xAuthKey, xAuthDigest, xMessageId, inlineObject1, _callback);
        Type localVarReturnType = new TypeToken<MerchantTransactionResults>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public MerchantTransactionResults refundMerchantTransaction(String xApiKey, String authorization, String xJWSSignature, String transactionId, RefundMerchantTransactionRequest refundMerchantTransactionRequest, String xAuthKey, String xAuthDigest, String xMessageId) throws ApiException {
        ApiResponse<MerchantTransactionResults> localVarResp = refundMerchantTransactionWithHttpInfo(xApiKey, authorization, xJWSSignature, transactionId, refundMerchantTransactionRequest, xAuthKey, xAuthDigest, xMessageId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<MerchantTransactionResults> refundMerchantTransactionWithHttpInfo(String xApiKey, String authorization, String xJWSSignature, String transactionId, RefundMerchantTransactionRequest refundMerchantTransactionRequest, String xAuthKey, String xAuthDigest, String xMessageId) throws ApiException {
     ...
     */
    public okhttp3.Call refundMerchantTransactionAsync(String xApiKey, String authorization, String xJWSSignature, String transactionId, RefundMerchantTransactionRequest refundMerchantTransactionRequest, String xAuthKey, String xAuthDigest, String xMessageId, final ApiCallback<MerchantTransactionResults> _callback) throws ApiException {
