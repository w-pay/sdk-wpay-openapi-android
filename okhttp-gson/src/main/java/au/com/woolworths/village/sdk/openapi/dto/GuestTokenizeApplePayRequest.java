...
/**
 * The JSON request structure of the Guest Tokenize Apple Pay endpoint.
 */
@ApiModel(description = "The JSON request structure of the Guest Tokenize Apple Pay endpoint.")

public class GuestTokenizeApplePayRequest implements Serializable {
  ...
  public GuestTokenizeApplePayRequest data(String data) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest ephemeralPublicKey(String ephemeralPublicKey) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest publicKeyHash(String publicKeyHash) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest transactionId(String transactionId) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest signature(String signature) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest version(String version) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest instrumentType(String instrumentType) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest comment(String comment) {
  ...
  **/
  ...
  public GuestTokenizeApplePayRequest applicationData(String applicationData) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    GuestTokenizeApplePayRequest guestTokenizeApplePayRequest = (GuestTokenizeApplePayRequest) o;
    return Objects.equals(this.data, guestTokenizeApplePayRequest.data) &&
        Objects.equals(this.ephemeralPublicKey, guestTokenizeApplePayRequest.ephemeralPublicKey) &&
        Objects.equals(this.publicKeyHash, guestTokenizeApplePayRequest.publicKeyHash) &&
        Objects.equals(this.transactionId, guestTokenizeApplePayRequest.transactionId) &&
        Objects.equals(this.signature, guestTokenizeApplePayRequest.signature) &&
        Objects.equals(this.version, guestTokenizeApplePayRequest.version) &&
        Objects.equals(this.instrumentType, guestTokenizeApplePayRequest.instrumentType) &&
        Objects.equals(this.comment, guestTokenizeApplePayRequest.comment) &&
        Objects.equals(this.applicationData, guestTokenizeApplePayRequest.applicationData);
  }

  @Override
  public int hashCode() {
    return Objects.hash(data, ephemeralPublicKey, publicKeyHash, transactionId, signature, version, instrumentType, comment, applicationData);
  }
  ...
  public String toString() {
    ...
    sb.append("class GuestTokenizeApplePayRequest {\n");
