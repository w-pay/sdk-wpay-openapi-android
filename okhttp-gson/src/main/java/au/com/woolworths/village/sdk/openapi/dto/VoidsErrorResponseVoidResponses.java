...
/**
 * VoidsErrorResponseVoidResponses
 */

public class VoidsErrorResponseVoidResponses implements Serializable {
  ...
  public VoidsErrorResponseVoidResponses paymentTransactionRef(String paymentTransactionRef) {
  ...
  **/
  ...
  public VoidsErrorResponseVoidResponses errorCode(String errorCode) {
  ...
  **/
  ...
  public VoidsErrorResponseVoidResponses errorMessage(String errorMessage) {
  ...
  **/
  ...
  public VoidsErrorResponseVoidResponses errorDetail(String errorDetail) {
  ...
  **/
  ...
  public VoidsErrorResponseVoidResponses externalServiceCode(String externalServiceCode) {
  ...
  **/
  ...
  public VoidsErrorResponseVoidResponses externalServiceMessage(String externalServiceMessage) {
  ...
  **/
  @ApiModelProperty(example = "INVALID VOID AUTH NOT FOUND", required = true, value = "The external service message (from eg. Webpay). This property is only included in the response if it is enabled in the consumers API configuration.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    VoidsErrorResponseVoidResponses voidsErrorResponseVoidResponses = (VoidsErrorResponseVoidResponses) o;
    return Objects.equals(this.paymentTransactionRef, voidsErrorResponseVoidResponses.paymentTransactionRef) &&
        Objects.equals(this.errorCode, voidsErrorResponseVoidResponses.errorCode) &&
        Objects.equals(this.errorMessage, voidsErrorResponseVoidResponses.errorMessage) &&
        Objects.equals(this.errorDetail, voidsErrorResponseVoidResponses.errorDetail) &&
        Objects.equals(this.externalServiceCode, voidsErrorResponseVoidResponses.externalServiceCode) &&
        Objects.equals(this.externalServiceMessage, voidsErrorResponseVoidResponses.externalServiceMessage);
  }
  ...
  public String toString() {
    ...
    sb.append("class VoidsErrorResponseVoidResponses {\n");
