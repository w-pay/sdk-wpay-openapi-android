...
public class PaymentsErrorResponseCreditCards implements Serializable {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(paymentInstrumentId, paymentToken, errorCode, errorMessage, errorDetail, stepUp, receiptData, extendedTransactionData, externalServiceCode, externalServiceMessage);
  }
