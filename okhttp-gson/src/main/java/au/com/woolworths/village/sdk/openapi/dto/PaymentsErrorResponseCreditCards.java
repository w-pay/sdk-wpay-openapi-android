...
/**
 * PaymentsErrorResponseCreditCards
 */

public class PaymentsErrorResponseCreditCards implements Serializable {
  ...
  public PaymentsErrorResponseCreditCards paymentInstrumentId(String paymentInstrumentId) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards paymentToken(String paymentToken) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards errorCode(String errorCode) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards errorMessage(String errorMessage) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards errorDetail(String errorDetail) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards stepUp(VerifyPaymentInstrumentsErrorResponseStepUp stepUp) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards receiptData(PaymentsSuccessResponseReceiptData receiptData) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards extendedTransactionData(List<PaymentsSuccessResponseExtendedTransactionData> extendedTransactionData) {
    
    this.extendedTransactionData = extendedTransactionData;
    return this;
  }

  public PaymentsErrorResponseCreditCards addExtendedTransactionDataItem(PaymentsSuccessResponseExtendedTransactionData extendedTransactionDataItem) {
  ...
  **/
  ...
  public PaymentsErrorResponseCreditCards externalServiceCode(String externalServiceCode) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "05", value = "The external service code (from eg. Webpay). This property is only included in the response if it is enabled in the consumers API configuration.")
  ...
  public PaymentsErrorResponseCreditCards externalServiceMessage(String externalServiceMessage) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "DO NOT HONOUR", value = "The external service message (from eg. Webpay). This property is only included in the response if it is enabled in the consumers API configuration.")
  ...
  public PaymentsErrorResponseCreditCards threeDS(PaymentsSuccessResponseThreeDS threeDS) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PaymentsErrorResponseCreditCards paymentsErrorResponseCreditCards = (PaymentsErrorResponseCreditCards) o;
    return Objects.equals(this.paymentInstrumentId, paymentsErrorResponseCreditCards.paymentInstrumentId) &&
        Objects.equals(this.paymentToken, paymentsErrorResponseCreditCards.paymentToken) &&
        Objects.equals(this.errorCode, paymentsErrorResponseCreditCards.errorCode) &&
        Objects.equals(this.errorMessage, paymentsErrorResponseCreditCards.errorMessage) &&
        Objects.equals(this.errorDetail, paymentsErrorResponseCreditCards.errorDetail) &&
        Objects.equals(this.stepUp, paymentsErrorResponseCreditCards.stepUp) &&
        Objects.equals(this.receiptData, paymentsErrorResponseCreditCards.receiptData) &&
        Objects.equals(this.extendedTransactionData, paymentsErrorResponseCreditCards.extendedTransactionData) &&
        Objects.equals(this.externalServiceCode, paymentsErrorResponseCreditCards.externalServiceCode) &&
        Objects.equals(this.externalServiceMessage, paymentsErrorResponseCreditCards.externalServiceMessage) &&
        Objects.equals(this.threeDS, paymentsErrorResponseCreditCards.threeDS);
  }

  @Override
  public int hashCode() {
    return Objects.hash(paymentInstrumentId, paymentToken, errorCode, errorMessage, errorDetail, stepUp, receiptData, extendedTransactionData, externalServiceCode, externalServiceMessage, threeDS);
  }
  ...
  public String toString() {
    ...
    sb.append("class PaymentsErrorResponseCreditCards {\n");
